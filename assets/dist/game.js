...
class Game extends base_1.Base {
    constructor({ id = undefined, created = undefined, lastUpdated = undefined, score = [0, 0], winner = null, servingTeam = 0, servingSide = 1, firstTo = 21, upperLimit = 30, court }) {
    ...
    swapSides(team) {
        let previousLeft = this.court[team].getByIndex(0);
        this.court[team].replaceAtIndex(0, this.court[team].getByIndex(1));
    ...
    setService(serviceTeam, serviceSide) {
...
exports.Game = Game;
let players = new list_1.List(player_1.testPlayers);
exports.testGame = new Game({
    court: [
