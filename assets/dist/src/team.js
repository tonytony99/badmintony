...
exports.Team = Team;
// // console.log("D")
let testPlayer1 = new player_1.Player({ name: 'A 1' });
let testPlayer2 = new player_1.Player({ name: 'B 2' });
let testPlayer3 = new player_1.Player({ name: 'C 3' });
let testPlayer4 = new player_1.Player({ name: 'D 4' });
let testPlayer5 = new player_1.Player({ name: 'E 5' });
